...
public class ShopDetailServiceImpl implements ShopDetailService {
    ...
    public void applyShop(ShopDetailDTO shopDetailDTO) {
        ...
        ShopDetail newShopDetail = mapperFactory.getMapperFacade().map(shopDetailDTO, ShopDetail.class);
        // 申请开店
    ...
    public void createShop(ShopDetailDTO shopDetailDTO) {
        ...
        // 保存店铺
        ShopDetail shopDetail = mapperFactory.getMapperFacade().map(shopDetailDTO, ShopDetail.class);
