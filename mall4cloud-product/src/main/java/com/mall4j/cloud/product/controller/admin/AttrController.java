...
public class AttrController {
    ...
    public ServerResponseEntity<Void> save(@Valid @RequestBody AttrDTO attrDTO) {
        ...
        Attr attr = mapperFactory.getMapperFacade().map(attrDTO, Attr.class);
        attr.setAttrValues(mapperFactory.getMapperFacade().mapAsList(attrDTO.getAttrValues(), AttrValue.class));
