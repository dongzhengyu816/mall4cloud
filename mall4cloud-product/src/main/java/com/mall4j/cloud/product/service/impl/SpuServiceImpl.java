...
public class SpuServiceImpl implements SpuService {
    ...
    public void save(SpuDTO spuDTO) {
        Spu spu = mapperFactory.getMapperFacade().map(spuDTO, Spu.class);
        ...
        List<SpuAttrValue> spuAttrValues = mapperFactory.getMapperFacade().mapAsList(spuDTO.getSpuAttrValues(), SpuAttrValue.class);
...
//            esProductBO.setShopPrimaryCategoryName(shopCategory.getPathNames().get(0));
        ...
        esProductBO.setAttrs(mapperFactory.getMapperFacade().mapAsList(attrs, EsAttrBO.class));
        return esProductBO;
    }
